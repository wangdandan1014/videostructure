...
public class CaptureServer {
  ...
  public interface Iface {
    ...
    public CapReturn DelChannel(String strChannelID) throws org.apache.thrift.TException;
    ...
    public CapReturn OpenCloseChannels(java.util.List<String> lstChnls, int iOpenFlag, int iAllFlag) throws org.apache.thrift.TException;

    public CapReturn GetVideoProgress(String strChannelID) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void DelChannel(String strChannelID, org.apache.thrift.async.AsyncMethodCallback<CapReturn> resultHandler) throws org.apache.thrift.TException;
    ...
    public void OpenCloseChannels(java.util.List<String> lstChnls, int iOpenFlag, int iAllFlag, org.apache.thrift.async.AsyncMethodCallback<CapReturn> resultHandler) throws org.apache.thrift.TException;

    public void GetVideoProgress(String strChannelID, org.apache.thrift.async.AsyncMethodCallback<CapReturn> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_DelChannel(String strChannelID) throws org.apache.thrift.TException
    {
    ...
    public void send_OpenCloseChannels(java.util.List<String> lstChnls, int iOpenFlag, int iAllFlag) throws org.apache.thrift.TException
    {
    ...
    public void send_GetVideoProgress(String strChannelID) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class DelChannel_call extends org.apache.thrift.async.TAsyncMethodCall<CapReturn> {
      ...
      public DelChannel_call(String strChannelID, org.apache.thrift.async.AsyncMethodCallback<CapReturn> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
    ...
    public static class OpenCloseChannels_call extends org.apache.thrift.async.TAsyncMethodCall<CapReturn> {
      private java.util.List<String> lstChnls;
      private int iOpenFlag;
      private int iAllFlag;
      public OpenCloseChannels_call(java.util.List<String> lstChnls, int iOpenFlag, int iAllFlag, org.apache.thrift.async.AsyncMethodCallback<CapReturn> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
    ...
    public static class GetVideoProgress_call extends org.apache.thrift.async.TAsyncMethodCall<CapReturn> {
      private String strChannelID;
      public GetVideoProgress_call(String strChannelID, org.apache.thrift.async.AsyncMethodCallback<CapReturn> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.strChannelID = strChannelID;
      }
  ...
  public static class DelChannel_args implements org.apache.thrift.TBase<DelChannel_args, DelChannel_args._Fields>, java.io.Serializable, Cloneable, Comparable<DelChannel_args>   {
    ...
    public DelChannel_args setStrChannelID(String strChannelID) {
      this.strChannelID = strChannelID;
      return this;
    }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("DelChannel_args(");
      boolean first = true;
  ...
  public static class DelChannel_result implements org.apache.thrift.TBase<DelChannel_result, DelChannel_result._Fields>, java.io.Serializable, Cloneable, Comparable<DelChannel_result>   {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("DelChannel_result(");
      boolean first = true;
  ...
  public static class DelChannelByRegionID_args implements org.apache.thrift.TBase<DelChannelByRegionID_args, DelChannelByRegionID_args._Fields>, java.io.Serializable, Cloneable, Comparable<DelChannelByRegionID_args>   {
    ...
    public int compareTo(DelChannelByRegionID_args other) {
      ...
      lastComparison = Boolean.valueOf(isSetIRegionID()).compareTo(other.isSetIRegionID());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetIRegionID()) {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("DelChannelByRegionID_args(");
      boolean first = true;
  ...
  public static class DelChannelByRegionID_result implements org.apache.thrift.TBase<DelChannelByRegionID_result, DelChannelByRegionID_result._Fields>, java.io.Serializable, Cloneable, Comparable<DelChannelByRegionID_result>   {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("DelChannelByRegionID_result(");
      boolean first = true;
  ...
  public static class ModifyChannel_args implements org.apache.thrift.TBase<ModifyChannel_args, ModifyChannel_args._Fields>, java.io.Serializable, Cloneable, Comparable<ModifyChannel_args>   {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("ModifyChannel_args(");
      boolean first = true;
  ...
  public static class ModifyChannel_result implements org.apache.thrift.TBase<ModifyChannel_result, ModifyChannel_result._Fields>, java.io.Serializable, Cloneable, Comparable<ModifyChannel_result>   {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("ModifyChannel_result(");
      boolean first = true;
  ...
  public static class OpenCloseChannels_args implements org.apache.thrift.TBase<OpenCloseChannels_args, OpenCloseChannels_args._Fields>, java.io.Serializable, Cloneable, Comparable<OpenCloseChannels_args>   {
    ...
    public java.util.List<String> lstChnls; // required
    ...
    public OpenCloseChannels_args(
      java.util.List<String> lstChnls,
      int iOpenFlag,
      int iAllFlag)
    {
      this();
    ...
    public OpenCloseChannels_args(OpenCloseChannels_args other) {
      ...
      if (other.isSetLstChnls()) {
        java.util.List<String> __this__lstChnls = new java.util.ArrayList<String>(other.lstChnls);
    ...
    public java.util.Iterator<String> getLstChnlsIterator() {
      return (this.lstChnls == null) ? null : this.lstChnls.iterator();
    }

    public void addToLstChnls(String elem) {
      if (this.lstChnls == null) {
        this.lstChnls = new java.util.ArrayList<String>();
      }
      this.lstChnls.add(elem);
    }

    public java.util.List<String> getLstChnls() {
      return this.lstChnls;
    }

    public OpenCloseChannels_args setLstChnls(java.util.List<String> lstChnls) {
      this.lstChnls = lstChnls;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case LST_CHNLS:
        if (value == null) {
          ...
          setLstChnls((java.util.List<String>)value);
        }
        break;
    ...
    public int compareTo(OpenCloseChannels_args other) {
      ...
      lastComparison = Boolean.valueOf(isSetLstChnls()).compareTo(other.isSetLstChnls());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetLstChnls()) {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("OpenCloseChannels_args(");
      boolean first = true;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.lstChnls = new java.util.ArrayList<String>(_list48.size);
                  String _elem49;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, OpenCloseChannels_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.lstChnls != null) {
          oprot.writeFieldBegin(LST_CHNLS_FIELD_DESC);
          {
            ...
            for (String _iter51 : struct.lstChnls)
            {
        ...
        if (struct.isSetLstChnls()) {
          {
            ...
            for (String _iter52 : struct.lstChnls)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.lstChnls = new java.util.ArrayList<String>(_list53.size);
            String _elem54;
  ...
  public static class OpenCloseChannels_result implements org.apache.thrift.TBase<OpenCloseChannels_result, OpenCloseChannels_result._Fields>, java.io.Serializable, Cloneable, Comparable<OpenCloseChannels_result>   {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("OpenCloseChannels_result(");
      boolean first = true;
  ...
  public static class GetVideoProgress_args implements org.apache.thrift.TBase<GetVideoProgress_args, GetVideoProgress_args._Fields>, java.io.Serializable, Cloneable, Comparable<GetVideoProgress_args>   {
    ...
    public GetVideoProgress_args setStrChannelID(String strChannelID) {
      this.strChannelID = strChannelID;
      return this;
    }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("GetVideoProgress_args(");
      boolean first = true;
  ...
  public static class GetVideoProgress_result implements org.apache.thrift.TBase<GetVideoProgress_result, GetVideoProgress_result._Fields>, java.io.Serializable, Cloneable, Comparable<GetVideoProgress_result>   {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("GetVideoProgress_result(");
      boolean first = true;
