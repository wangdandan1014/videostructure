...
public class RequestInfoLog {
	...
	public Object cut(ProceedingJoinPoint joinPoint) {
		...
		if (request.getRequestURI().indexOf("queryThriftChannel") < 0
				...
				&& request.getRequestURI().indexOf("checkFile") < 0
				&& request.getRequestURI().indexOf("uploadChuncks") < 0
				&& request.getRequestURI().indexOf("callRecordVideo") < 0
