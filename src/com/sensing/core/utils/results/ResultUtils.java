...
public class ResultUtils {
	...
	public static ResponseBean NONE() {
		ResponseBean result = new ResponseBean(ResultEnum.NONE.getCode(), ResultEnum.NONE.getMsg());
		return result;
	}
	public static ResponseBean EMPTY() {
		ResponseBean result = new ResponseBean(ResultEnum.EMPTY.getCode(), ResultEnum.EMPTY.getMsg());
		return result;
	}
