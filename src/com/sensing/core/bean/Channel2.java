...
public class Channel2 extends BaseModel implements Serializable {

	private static final long serialVersionUID = 1L;
	private String uuid;
	@ExcelVOAttribute(name = "通道名称", column = "A", isExport = true)
	private String channelName;
	@ExcelVOAttribute(name = "通道描述", column = "N", isExport = true)
	...
	@ExcelVOAttribute(name = "账号", column = "G", isExport = true)
	private String channelUid;// 账号
	@ExcelVOAttribute(name = "视频密码", column = "H", isExport = true)
	...
	@ExcelVOAttribute(name = "通道经度", column = "K", isExport = true)
	private Double channelLongitude;
	@ExcelVOAttribute(name = "通道纬度", column = "L", isExport = true)
	private Double channelLatitude;
	@ExcelVOAttribute(name = "通道位置", column = "M", isExport = true)
	private String channelArea;
	private Integer channelDirect;
	@ExcelVOAttribute(name = "通道方向", column = "J", isExport = true)
...
//		}
	...
	public List<Channel2> getChildChannels() {
		return childChannels;
	}

	public void setChildChannels(List<Channel2> childChannels) {
